      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between pb-4">
          ...
          <Link href={`/guitarras/${url}`} legacyBehavior>
            <a className="bg-slate-900 text-white text-center font-bold text-lg uppercase rounded-md px-3 hover:bg-slate-700 hover:text-slate-100 ease-in-out duration-300">
              Ver guitarra
            </a>
          </Link>
        </div>
